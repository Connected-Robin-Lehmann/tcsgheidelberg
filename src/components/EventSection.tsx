          ...
          <Card className="card-tennis bg-gradient-to-br from-tennis-yellow-light to-white border-tennis-yellow/20">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center text-gray-700">
                ...
                <span>{t('home.events.saturday')}, 19. Juli 2025 - {t('home.events.time')}</span>
              </div>
              <div className="flex items-center text-gray-700">
                <MapPin className="h-5 w-5 mr-2" />
                <span>{t('home.events.clubGrounds')}</span>
              </div>
              <div className="flex items-center text-gray-700">
            ...
            <p className="text-gray-700 mb-6">
              {t('home.events.meetingDescription')}
            </p>
