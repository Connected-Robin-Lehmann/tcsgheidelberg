        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Innovative Maßnahmen und infrastrukturelle Großprojekte für die
            ...
            <div className="p-8 md:p-12">
              <div className="prose prose-lg max-w-none mb-12">
                <p className="text-gray-700 leading-relaxed mb-8">
                  Innovative Maßnahmen und infrastrukturelle Großprojekte, die
                  nur mittelbar den Tennissport direkt betreffen, stellen heute
                  ganz neue Anforderungen an einen Tennisverein wie unseren TC
                  Schwarz-Gelb Heidelberg e.V.. Auch hier gilt grundsätzlich
                  hohe Seriosität und Qualität bei der Umsetzung neuer Ideen und
                  Projekte in unserem Verein.
                </p>

                <p className="text-gray-700 leading-relaxed mb-8">
                  An dieser Stelle möchten wir deshalb über anstehende
                  Großprojekte und Vorhaben informieren und eine Plattform
                  bieten, alle Mitglieder schon frühzeitig von der ersten Idee
                  bis hin zur Konzeption und Umsetzung eines zukünftigen
                  Projektes strukturiert mit relevanten Informationen zu
                  versorgen.
                </p>
                ...
                <div className="bg-tennis-black rounded-2xl p-8 text-white">
                  ...
                  <p className="leading-relaxed">
                    Jedes unserer Projekte wird mit höchster Sorgfalt geplant
                    und umgesetzt. Dabei stehen die Bedürfnisse unserer
                    Mitglieder und die langfristige Entwicklung des Vereins im
                    Mittelpunkt. Transparenz und regelmäßige Information über
                    den Fortschritt sind uns dabei besonders wichtig.
                  </p>
                </div>
              </div>
            </div>
