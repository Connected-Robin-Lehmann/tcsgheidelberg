    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="py-16 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4 max-w-6xl">
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                        ...
                        {event.id === "sommerfest-2026" && (
                          <a
                            ...
                            aria-label="View full Sommerfest invitation"
                          >
                            <img
                              src="/images/events/sommerfest-2026.png"
                              alt="Invitation to the TC Schwarz-Gelb Heidelberg summer party on 18.07.2026"
          ...
          {seasonEvents.length > 0 && (
            <div className="mb-16">
              ...
              <div className="space-y-6">
                ...
                {[
                  { date: "16.03.2026", title: "Registration Deadline Summer Training 2026" },
                  { date: "29.03.–09.04.2026", title: "Air-Supported Hall Dismantling" },
                  { date: "13.04.2026", title: "Start of Summer Training" },
                  { date: "06.05.2026", title: "Start of League Season (Medenrunde)" },
                ].map((item) => (
          ...
          {/* Oberliga & Badenliga Home Match Dates */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-tennis-black mb-8 flex items-center gap-3">
              <span className="text-4xl">🏸</span>
              Home Match Dates Oberliga and Badenliga Teams
            </h2>
                ...
                <div className="space-y-4">
                  <Card className="p-4 hover:shadow-lg transition-shadow">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center text-gray-600">
                        <Clock className="h-4 w-4 mr-2 text-tennis-yellow" />
                        <span>likely from 10 AM (moved up), otherwise from 2 PM</span>
                      </div>
                    </div>
                  </Card>
                  <Card className="p-4 hover:shadow-lg transition-shadow">
