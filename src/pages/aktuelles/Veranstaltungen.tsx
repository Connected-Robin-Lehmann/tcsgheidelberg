...
const Veranstaltungen = () => {
  const upcomingEvents = [
    ...
    },
    {
      ...
      description: "Offizielle Eröffnung der Tennissaison mit traditionellem Turnier",
      type: "Turnier"
    },
    {
    ...
    },
    {
      ...
      description: "Kombiniert mit Nuit Blanche - unser jährliches Vereinshighlight",
      type: "Versammlung"
    },
    {
      ...
      location: "Tennisanlage",
      description: "Powered by Engelhorn Sports - unser traditionelles Jugendturnier",
      type: "Turnier"
    },
    {
    ...
    },
    {
      ...
      location: "Clubhaus",
      description: "Gemütliches Beisammensein mit traditionellem Thanksgiving-Essen",
      type: "Essen"
    }
  ];
  ...
  const getEventTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'Turnier': return 'bg-tennis-yellow/20 text-tennis-black';
      case 'Camp': return 'bg-blue-100 text-blue-800';
      case 'Versammlung': return 'bg-red-100 text-red-800';
      case 'Training': return 'bg-orange-100 text-orange-800';
      case 'Infrastruktur': return 'bg-gray-100 text-gray-800';
      case 'Essen': return 'bg-amber-100 text-amber-800';
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hier finden Sie alle kommenden Termine und Veranstaltungen unseres Vereins geordnet und übersichtlich
            </p>
          </div>
          ...
          <div className="grid gap-8">
            {upcomingEvents.map((event, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg border-4 border-tennis-yellow/20 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                    <div className="flex items-center mb-4 md:mb-0">
                      ...
                      <div>
                        ...
                        <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium mt-2 ${getEventTypeColor(event.type)}`}>
                          {event.type}
                        </div>
                      </div>
                    </div>
