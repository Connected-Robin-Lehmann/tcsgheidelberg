...
const Aktuelles = () => {
  ...
  const getEventIcon = (type: string) => {
    switch (type) {
      ...
      case 'tournament': return <Calendar className="h-5 w-5" />;
      case 'meeting': return <Users className="h-5 w-5" />;
      case 'maintenance': return <MapPin className="h-5 w-5" />;
      case 'social': return <Calendar className="h-5 w-5" />;
  ...
  const getEventColor = (type: string) => {
    switch (type) {
      case 'training': return 'border-l-tennis-yellow bg-tennis-yellow/5';
      case 'tournament': return 'border-l-red-500 bg-red-50';
      case 'meeting': return 'border-l-blue-500 bg-blue-50';
      case 'maintenance': return 'border-l-green-500 bg-green-50';
      case 'social': return 'border-l-purple-500 bg-purple-50';
      default: return 'border-l-tennis-yellow bg-tennis-yellow/5';
    }
  };
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {upcomingEvents.map((event, index) => (
                <Card key={index} className={`border-l-4 ${getEventColor(event.type)} hover:shadow-lg transition-all duration-300`}>
                  <div className="p-6">
              ...
              <Card className="card-tennis border-l-4 border-l-tennis-yellow">
                <div className="p-6">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed mb-4">
                    Beim Crowdfunding finanziert ein einzelner oder mehrere mit kleinen oder auch 
              ...
              <Card className="card-tennis border-l-4 border-l-green-500">
                <div className="p-6">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed mb-4">
                    ...
                    Planungen im und rund um den Club teilen wir als Vorstand in unserem Newsletter mit.
                  </p>
                  <Button variant="outline" className="btn-hero-outline w-full">
                    Newsletter lesen
                  </Button>
