...
const FoerdervereinEN = () => {
  ...
  const supportOptions = [
    ...
    },
    {
      ...
      title: "Sponsor",
      description:
        "With almost 600 members, a 36% youth share and 10 of our own courts, we offer excellent opportunities to combine sports promotion with targeted public relations.",
      action: "Schedule a personal meeting",
    },
    {
      icon: <Heart className="h-8 w-8 text-tennis-yellow" />,
      title: "Patron (silent supporter)",
      description:
        "Support us without appearing publicly as a donor. You will receive a tax-deductible donation receipt for the contributions made.",
