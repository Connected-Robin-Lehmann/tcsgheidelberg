        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Werden Sie Teil unserer Tennisfamilie im TC Schwarz-Gelb Heidelberg e.V.
            </p>
          </div>
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none mb-8">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Sie haben Lust auf Tennis in toller Atmosphäre mitten in Heidelberg? Sie möchten selbst
                  den Schläger erstmals oder nach vielen Jahren der Pause wieder in die Hand nehmen um Ball
                  und Gegner über den Platz zu treiben? Dann freuen wir uns auf Sie als neues Mitglied in
                  unserem Traditionsverein.
                </p>
                <p className="text-gray-700 leading-relaxed mb-8">
                  Als neues Mitglied können Sie sich sicher sein, dass Sie nicht nur Spaß am Spiel, sondern
                  auch neue Freunde finden werden. Mit unseren vielen, unterschiedlich starken und
                  ambitionierten Spielern stehen Ihnen in jedem Fall viele nette Menschen zur Seite, die
                  den Tennissport genauso lieben wie Sie!
                </p>
              </div>

              {/* Membership Info */}
              <div className="bg-tennis-yellow/10 rounded-2xl p-8 mb-8">
                <h3 className="text-2xl font-bold text-tennis-black mb-6">Beitragsinformationen</h3>
                <ul className="space-y-3 text-gray-700">
                  <li>• Ermäßigte Tarife für Familien, Jugendliche und Studenten</li>
                  <li>• Ermäßigte Beträge bei Eintritt nach dem 15.7. bis Jahresende</li>
                  <li>• Neue Beitragsordnung ab 01.01.2026 (beschlossen am 19.10.2025)</li>
                  <li>
                    • Keine „Probe-" oder „Schnupper"-Mitgliedschaften verfügbar – es kann aber ein
                    Probetraining bei einer der Tennisschulen{" "}
              ...
              <div className="bg-tennis-black rounded-2xl p-8 text-white mb-8">
                <h3 className="text-2xl font-bold text-tennis-yellow mb-6">Hinweis Arbeitsstunden</h3>
                <p>
                  Ab dem Jahr 2026 muss jedes Mitglied im Alter von 16–65 Jahren einmal pro Jahr einen
                  Arbeitseinsatz von 2 Stunden für den Verein erbringen. Ansonsten sind am Jahresende 15
                  Euro pro nichtgeleisteter Stunde zu bezahlen – der Betrag wird entsprechend eingezogen
          ...
          <Card className="border-tennis-yellow/20">
            ...
            <CardContent>
              <p className="text-gray-700 mb-6">
                Fragen zur Änderung der Mitgliedschaft, zu Beitragsrechnungen und zu Änderungen der
                Stammdaten (etwa Adresse, Email, Bankverbindung, Telefonnummer etc.) teilen Sie uns bitte
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-4">
                <p className="text-red-800 font-semibold">
                  Wichtig: Eine Kündigungs- bzw. Austrittserklärung muss dem Vorstand spätestens zum
                  Ablauf des 30.09. eines jeden Jahres in Schriftform (Brief oder E-Mail) vorliegen.
                </p>
              </div>
            </CardContent>
          </Card>
