            ...
            <div className="p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none mb-8">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Hier finden Sie alle Details zu unseren Beiträgen. Für Familien, Jugendliche und Studenten 
                  haben wir natürlich auch ermäßigte Tarife. Auch bieten wir im ersten Jahr der Aufnahme bei 
                  Eintritt nach dem 15.7. ermäßigte Beträge bis zum Jahresende.
                </p>
                ...
                <div className="bg-tennis-yellow/10 rounded-2xl p-8 mb-8 border-l-4 border-tennis-yellow">
                  ...
                  <p className="text-gray-700">
                    Es gilt eine neue Beitragsordnung ab 2021. Diese wurde von der Mitgliederversammlung am 
                    11.10.2020 beschlossen. Die untenstehende Tabelle zeigt die ab 01.01.2021 geltende 
                    Beitragsordnung.
                  </p>
                </div>
              </div>
                  ...
                  <Card key={index} className="border-tennis-yellow/20">
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-bold text-tennis-black">{membership.type}</h4>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-red-50 rounded-2xl p-6 border-l-4 border-red-400">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-red-800 mb-2">Wichtiger Hinweis</h4>
                ...
                <div className="bg-green-50 rounded-2xl p-6 border-l-4 border-green-400">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-green-800 mb-2">Mitgliedsantrag</h4>
                      <p className="text-green-700 text-sm">
                        Die aktuelle gültige Fassung des Mitgliedsantrags steht als Download zur Verfügung.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 mb-8">
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    ...
                    Selbstüberweisung gemäß Beitragsordnung zusätzlich <strong>EUR 25,-</strong> als 
              ...
              <div className="bg-tennis-black rounded-2xl p-8 text-white mb-8">
                ...
                <div className="space-y-4">
                  <p>
                    Im Jahr 2022 werden zusätzlich (gemäß Beschluss der Mitgliederversammlung vom 11.10.2020) 
                    einmalig <strong>EUR 20,-</strong> pro aktivem erwachsenen Mitglied (25-65 Jahre alt) als 
                    Infrastrukturabgabe erhoben.
                  </p>
                  <p>
                    Für alle Folgejahre (2023 ff.) entscheidet die Mitgliederversammlung jährlich (konkret auf 
                    der Mitgliederversammlung im Vorjahr) auf Antrag in einem Tagesordnungspunkt, ob im Folgejahr 
                    überhaupt eine Infrastrukturabgabe erhoben werden soll, und falls ja, über die exakte Höhe 
                    des Betrages.
                  </p>
                </div>
              </div>
              ...
              <div className="text-center mb-8">
                <Button 
                  ...
                  onClick={() => window.open("https://www.schwarzgelb-heidelberg.de/wp-content/uploads/2021/01/Beitragsordnung-ab-2021-komplett.pdf", "_blank")}
                >
          ...
          <Card className="border-tennis-yellow/20">
            ...
            <CardContent>
              <p className="text-gray-700 mb-6">
                Fragen zur Änderung der Mitgliedschaft, zu Beitragsrechnungen und zu Änderungen der Stammdaten 
                (etwa Adresse, Email, Bankverbindung, Telefonnummer etc.) teilen Sie uns bitte ausschließlich mit unter:
              </p>
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-lg">
                <div className="flex items-start">
                  <AlertTriangle className="h-6 w-6 text-red-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-bold text-red-800 mb-2">Wichtige Kündigungsfrist</h4>
                    <p className="text-red-700">
                      Eine Kündigungs- bzw. Austrittserklärung muss dem Vorstand spätestens zum Ablauf des 
                      <strong> 30.09. eines jeden Jahres</strong> in Schriftform (Brief oder E-Mail) vorliegen. 
                      Eine Toleranz etwa durch Verzögerungen auf dem Postweg etc. ist aus Gründen der 
