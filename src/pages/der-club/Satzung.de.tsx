...
const SatzungDE = () => {
  const satzungPoints = [
    {
      title: "Vereinszweck",
      description: "Förderung des Tennis-Sports mit Spaß und Spiel",
    },
    {
      title: "Organisation",
      description: "Struktur des Vereins und der Gremien",
    },
    {
      title: "Vorstandsarbeit",
      description: "Handwerkszeug für die Vereinsführung",
    },
    {
      title: "Mitgliedschaft",
      description: "Rechte und Pflichten der Mitglieder",
    },
  ];
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none mb-8">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Das gemeinsame Ziel haben wir schon: die Förderung des
                  Tennis-Sports, gepaart mit Spaß und Spiel beim Ausführen
                  unseres Sports. Diesen Zweck haben wir in unserer
                  Vereinssatzung festgeschrieben.
                </p>

                <p className="text-gray-700 leading-relaxed mb-8">
                  Auch unser Verein, der als e.V. in das Vereinsregister
                  Mannheim eingetragen ist, braucht eine schriftliche Satzung.
                  Die Satzung ist die Verfassung des Clubs und quasi „das
                  Grundgesetz" und spiegelt die Ziele, den Zweck, die
                  Organisation der Vereinsarbeit und der Gremien etc. wieder.
                  Die Satzung beschreibt insbesondere die Struktur des Vereins
                  und ist das Handwerkszeug unseres Vorstands bei der Führung
                  unseres Tennis-Vereins.
                </p>
              </div>
              ...
              <div className="bg-tennis-yellow/10 rounded-2xl p-8 mb-8 border-l-4 border-tennis-yellow">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Auch unsere Satzung ist kein statisches Dokument und gültig
                  für alle Zeiten. So wie unser Verein lebt, muss auch unsere
                  Satzung im Laufe der Jahre immer angepasst oder aktualisiert
                  werden.
                </p>
              </div>
            ...
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <p className="text-gray-700">
                  Als eingetragener Verein (e.V.) im Vereinsregister Mannheim
                  unterliegen wir den gesetzlichen Bestimmungen des BGB und sind
                  zur Führung einer Satzung verpflichtet. Diese regelt alle
                  wesentlichen Aspekte unseres Vereinslebens transparent und
                  rechtsverbindlich.
                </p>
              </div>
            </CardContent>
