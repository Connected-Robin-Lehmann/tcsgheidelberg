      ...
      <section className="bg-gradient-to-r from-tennis-black to-gray-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            Unsere Damen-Teams in der Medenrunde
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <Card className="p-8 border-tennis-yellow border-2">
              <h2 className="text-2xl font-bold text-foreground mb-6">
                Damen-Mannschaften 2024
              </h2>
              <p className="text-lg leading-relaxed text-foreground mb-6">
                Unsere Damen-Mannschaften sind ein wichtiger Bestandteil unseres Vereins. 
                Mit unterschiedlichen Leistungsstärken bieten wir für jede Spielerin die 
                passende Mannschaft, um am Medenspiel teilzunehmen.
              </p>
              <p className="text-lg leading-relaxed text-foreground mb-8">
                Der „Leuchtturm" des TC Schwarz-Gelb Heidelberg e.V. ist die 
                Damenmannschaft, die in den letzten Jahren erfolgreich in der Badenliga 
                spielte und der 2019 sogar der Aufstieg in die Regionalliga gelang.
              </p>
              ...
              <div className="bg-gradient-to-r from-tennis-black to-gray-800 rounded-2xl p-8 text-center">
                ...
                <p className="text-white mb-6">
                  Die Mitglieder und Ergebnisse unserer Damen-Mannschaften finden Sie
