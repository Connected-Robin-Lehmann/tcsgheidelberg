...
import { Phone, Mail, MapPin, Trophy, Users, Calendar, Target, Award } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Kukaras Professional Tennis Services - Nachwuchsförderung auf höchstem Niveau
            </p>
          </div>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="bg-gradient-to-r from-tennis-yellow/10 to-tennis-yellow/5 rounded-2xl p-8 mb-8 border-l-4 border-tennis-yellow">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Die Jugend- und Nachwuchsarbeit war traditionell immer die Stärke des TC Schwarz-Gelb 
                    Heidelberg. Seit 2008 ist mit Alex Kukaras nach sechsjähriger Unterbrechung wieder 
                    der Trainer und Koordinator an Bord, der schon in der Vergangenheit bewiesen hat, 
                    dass Erfolge kein Zufall sind.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Alex konnte mit Mannschaften und Spielern unzählige Titel erringen. Bezirks-, 
                    Badische- und sogar Weltmeisterschaften wurden unter seiner Regie erlangt.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  <div className="bg-tennis-black rounded-2xl p-8 text-white">
                    ...
                    <p className="leading-relaxed mb-4">
                      Alex besitzt mit der A-Lizenz des Deutschen Tennis Bundes die höchste Lizenz 
                      im Tennissport. Wir bieten als Verein in Zusammenarbeit mit der Tennisschule 
                      Kukaras damit Nachwuchsarbeit auf höchstem Niveau.
                    </p>
                    <div className="bg-tennis-yellow/20 rounded-lg p-4">
                      <p className="text-sm font-medium">
                        Seit seinem erneuten Engagement hat sich die Zahl der Kinder und Jugendlichen 
                        in unserem Club erheblich erhöht.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-tennis-yellow/20 to-tennis-yellow/10 rounded-2xl p-8">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Selbstverständlich beschränkt sich das Trainingsangebot nicht nur auf Kinder 
                      und Jugendliche. Jedes Mitglied bei Schwarz-Gelb kann Trainings individuell 
                      buchen oder auch in Gruppentrainings je nach Verfügbarkeit und Eignung einsteigen.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border-2 border-gray-200 mb-12">
            ...
            <div className="p-8">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div>
                  <h3 className="text-xl font-bold text-tennis-black mb-4">Qualifikationen</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold text-tennis-black mb-4">Kontakt</h3>
            ...
            <div className="p-8">
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div className="mb-2 md:mb-0">
                        <h4 className="font-bold text-tennis-black">{camp.name}</h4>
                        <p className="text-sm text-gray-600">{camp.zeit}</p>
                      </div>
                      <div className="bg-tennis-yellow/20 px-4 py-2 rounded-lg">
                        <span className="font-semibold text-tennis-black">{camp.datum}</span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-8 bg-tennis-yellow/10 rounded-xl p-6">
                <p className="text-gray-700 font-medium text-center">
                  Weitere Informationen u.a. zur Anmeldung stehen bald zum Download zur Verfügung.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-tennis-black rounded-3xl p-8 text-white mb-12">
            <div className="text-center mb-6">
              ...
              <p className="leading-relaxed mb-6">
                Seit vielen Jahren regelmäßig in der Zeit von Anfang Oktober bis Anfang April 
                installiert die Tennisschule Kukaras die Tragluft-Tennishalle über den Plätzen 7 + 8.
              </p>
              <p className="leading-relaxed mb-6">
                So können unsere Mitglieder auch in der Wintersaison von September bis April die 
                Vorteile des Sandplatzspieles genießen. Umstellungs- und Anpassungsschwierigkeiten 
                vom Freiplatz auf den Hallenplatz gibt es damit nicht mehr.
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-tennis-yellow/20 rounded-xl p-6">
                <h4 className="font-bold text-tennis-yellow mb-3">Ausstattung</h4>
              ...
              <div className="bg-tennis-yellow/20 rounded-xl p-6">
                <h4 className="font-bold text-tennis-yellow mb-3">Information & Buchung</h4>
                <p className="text-sm mb-2">
                  Alexandar Kukaras<br />
                  Tel: 0172-66 44 369<br />
          ...
          <div className="bg-gradient-to-r from-tennis-yellow/10 to-tennis-yellow/5 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-700 leading-relaxed">
              Nach ersten Schnuppertrainingsstunden ist (u.a. aus Versicherungsgründen) eine 
              formale Mitgliedschaft beim TC Schwarz-Gelb Heidelberg e.V. Voraussetzung zum 
              Training auf der Anlage des Vereins.
            </p>
          </div>
        </div>
      </main>
