        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Trainingsmöglichkeiten für jeden Anspruch - von Anfängern bis zu
              ambitionierten Leistungssportlern
            </p>
          </div>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="bg-gradient-to-r from-tennis-yellow/10 to-tennis-yellow/5 rounded-2xl p-8 mb-8 border-l-4 border-tennis-yellow">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Ob Einzeltraining, Gruppentraining mit passenden
                    Sparringspartnern, Mannschaftstraining, Camps, Turniere oder
                    intensives Training zur Einzelförderung besonders
                    talentierter Junioren und Juniorinnen – bei uns findet
                    jeder, was er sucht.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    So vertraut unser TC Schwarz-Gelb Heidelberg e.V. seit sehr
                    vielen Jahren im Trainingsbetrieb auf das Know-How der
                    Tennisschulen Kukaras und Manfred Seibold.
                  </p>
                </div>
                ...
                <div className="bg-white border-2 border-tennis-yellow/20 rounded-2xl p-8 mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Unsere beiden Tennisschulen bieten Kinder- und
                    Jugendtrainings, Erwachsenentrainings und hier gleichermaßen
                    auch Einzel- und Mannschaftstrainings sowie Lehrgänge und
                    Camps im In- und Ausland an.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Vom Tennis für Anfänger bis zum ambitionierten
                    leistungsorientierten Tennissport sind Qualitätsanspruch,
                    Spaß und gleichermaßen Professionalität in allen Trainings
                ...
                <div className="bg-tennis-yellow/10 rounded-2xl p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Die Zielsetzung von Verein und Tennisschulen ist es, sowohl
                    jungen, wie auch erwachsenen SpielerInnen neue Perspektiven
                    aufzuzeigen und sie in Ihrem individuellen Können
                    weiterzuentwickeln.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-gray-100 hover:border-tennis-yellow/50 hover:shadow-xl transition-all duration-300">
              <div className="text-center">
                ...
                <p className="text-gray-700 mb-6">
                  Professionelle Jugend- und Nachwuchsarbeit mit der höchsten
                  DTB A-Lizenz. Spezialisiert auf die Entwicklung junger
                  Talente.
                </p>
                <a
          ...
          <div className="bg-gradient-to-r from-tennis-yellow/10 to-tennis-yellow/5 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Wenn Sie Interesse oder Fragen haben, nehmen Sie bitte direkt mit
              unseren Tennisschulen Kontakt auf. Unsere erfahrenen Trainer
              beraten Sie gerne und finden das passende Training für Ihre
              Bedürfnisse.
            </p>
