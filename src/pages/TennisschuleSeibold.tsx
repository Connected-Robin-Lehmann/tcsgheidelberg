...
import { Phone, Mail, Users, Target, Heart, Award, BookOpen } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Breitensport und Vereinsintegration - Tennis lernen mit Spaß und System
            </p>
          </div>
              ...
              <div className="prose prose-lg max-w-none">
                <div className="bg-gradient-to-r from-tennis-yellow/10 to-tennis-yellow/5 rounded-2xl p-8 mb-8 border-l-4 border-tennis-yellow">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Die Tennisschule Manfred Seibold mit ihrem erfahrenen Coach trainiert vorwiegend 
                    Neueinsteiger, Hobbyspieler und den Seniorenbereich, veranstaltet Einführungskurse 
                    und Tenniscamps.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
                    Sie gibt den Schülern gleich von Anfang an die Möglichkeit, ins Vereinsleben 
                    reinzuschnuppern, um anschließend Mitglied werden zu können und bei sportlicher 
                    Begabung, auch in einer der Mannschaften zu spielen.
                  </p>
                </div>
                ...
                <div className="bg-tennis-black rounded-2xl p-8 text-white mb-8">
                  ...
                  <p className="leading-relaxed">
                    Das Ziel ist es, den Spaß am Tennisspielen zu entdecken, und den Breitensport 
                    zu wecken und zu fördern. Tennis soll für jeden zugänglich und erlebbar werden - 
                    unabhängig vom Alter oder der sportlichen Vorerfahrung.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <ul className="space-y-3">
                    {qualifikationen.map((qualifikation, index) => (
                      <li key={index} className="flex items-start">
                        ...
                        <span className="text-gray-700 font-medium text-sm">{qualifikation}</span>
                      </li>
                    ))}
                  </ul>
                </div>
                  ...
                  <ul className="space-y-3">
                    {schwerpunkte.map((schwerpunkt, index) => (
                      <li key={index} className="flex items-start">
                        ...
                        <span className="text-gray-700 font-medium text-sm">{schwerpunkt}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <div className="bg-tennis-black rounded-2xl p-8 text-white text-center">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <span className="font-semibold">seibold-tennis@t-online.de</span>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center border-2 border-gray-100 hover:border-tennis-yellow/50 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Speziell entwickelte Programme für Tennis-Neulinge und alle, die nach einer 
                Pause wieder einsteigen möchten. Schritt für Schritt zum Erfolg.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center border-2 border-gray-100 hover:border-tennis-yellow/50 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Lernen Sie die richtige Taktik für Einzel und Doppel. Strategisches Denken 
                und cleveres Spiel machen den Unterschied aus.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center border-2 border-gray-100 hover:border-tennis-yellow/50 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Die mentale Stärke ist entscheidend. Konzentration, Selbstvertrauen und 
                der richtige Umgang mit Druck werden gezielt trainiert.
              </p>
            </div>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-xl p-6 border-l-4 border-tennis-yellow">
                  <h4 className="font-bold text-tennis-black mb-3">Vereinsintegration</h4>
                  <p className="text-gray-700 text-sm">
                    Von Anfang an ermöglichen wir das Schnuppern im Vereinsleben. Tennis ist 
                    ein Gemeinschaftssport - bei uns finden Sie schnell Anschluss.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 border-l-4 border-tennis-yellow">
                  <h4 className="font-bold text-tennis-black mb-3">Breitensport fördern</h4>
                  <p className="text-gray-700 text-sm">
                    Tennis für alle - das ist unser Motto. Egal ob Hobby oder ambitionierter 
                    Sport, wir finden für jeden den passenden Weg.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-tennis-black rounded-2xl p-8 text-white text-center">
            ...
            <p className="leading-relaxed">
              Nach ersten Schnupperstunden ist (u.a. aus Versicherungsgründen) eine formale 
              Mitgliedschaft beim TC Schwarz-Gelb Heidelberg e.V. Voraussetzung zum Training 
              auf der Anlage des Vereins.
            </p>
          </div>
        </div>
      </main>
