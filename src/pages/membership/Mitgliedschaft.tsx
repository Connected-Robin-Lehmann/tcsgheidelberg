            ...
            <div className="p-8 md:p-12">
              ...
              <div className="prose prose-lg max-w-none mb-8">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Sie haben Lust auf Tennis in toller Atmosphäre mitten in Heidelberg? Sie möchten selbst den 
                  Schläger erstmals oder nach vielen Jahren der Pause wieder in die Hand nehmen um Ball und 
                  Gegner über den Platz zu treiben? Dann freuen wir uns auf Sie als neues Mitglied in unserem 
                  Traditionsverein.
                </p>

                <p className="text-gray-700 leading-relaxed mb-8">
                  Als neues Mitglied können Sie sich sicher sein, dass Sie nicht nur Spaß am Spiel, sondern auch 
                  neue Freunde finden werden. Mit unseren vielen, unterschiedlich starken und ambitionierten 
                  Spielern stehen Ihnen in jedem Fall viele nette Menschen zur Seite, die den Tennissport genauso 
                  lieben wie Sie!
                </p>
              </div>
              ...
              <div className="bg-tennis-yellow/10 rounded-2xl p-8 mb-8">
                ...
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li>• Neue Beitragsordnung ab 01.01.2021 (beschlossen am 11.10.2020)</li>
                  <li>• Keine "Probe-" oder "Schnupper"-Mitgliedschaften verfügbar</li>
                </ul>
              </div>
              ...
              <div className="bg-tennis-black rounded-2xl p-8 text-white mb-8">
                ...
                <p className="mb-4">
                  Im Jahr 2023 werden zusätzlich (gemäß Beschluß der Mitgliederversammlung vom 18.09.2022) 
                  einmalig EUR 20,- pro aktivem erwachsenen Mitglied (25-65 Jahre alt) als Infrastrukturabgabe 
                  erhoben.
                </p>
                <p>
                  Für alle Folgejahre (2024 ff.) entscheidet die Mitgliederversammlung jährlich über eine 
                  eventuelle Infrastrukturabgabe und deren Höhe.
                </p>
              </div>
          ...
          <Card className="border-tennis-yellow/20">
            ...
            <CardContent>
              <p className="text-gray-700 mb-6">
                ...
                (etwa Adresse, Email, Bankverbindung, Telefonnummer etc.) teilen Sie uns bitte ausschließlich unter:
              </p>
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-4">
                <p className="text-red-800 font-semibold">
                  Wichtig: Eine Kündigungs- bzw. Austrittserklärung muss dem Vorstand spätestens zum Ablauf 
                  des 30.09. eines jeden Jahres in Schriftform (Brief oder E-Mail) vorliegen.
                </p>
              </div>
            </CardContent>
          </Card>
