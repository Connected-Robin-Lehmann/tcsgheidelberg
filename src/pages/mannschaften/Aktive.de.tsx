          ...
          <div className="bg-gradient-to-r from-tennis-black to-gray-800 rounded-2xl p-8 text-center">
            ...
            <div className="mt-6 pt-6 border-t border-white/20">
              <p className="text-xl font-bold text-white">
                Ansprechpartnerin für alle Aktiven Mannschaften: <a href="mailto:katharina.kukaras@schwarzgelb-heidelberg.de" className="text-tennis-yellow hover:underline">Katharina Kukaras</a>
              </p>
            </div>
          </div>
