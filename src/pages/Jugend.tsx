        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Die Zukunft des Tennis - Kinder- und Jugendförderung mit Tradition und Innovation
            </p>
          </div>
              ...
              <div className="prose prose-lg max-w-none mb-8">
                <div className="bg-gradient-to-r from-tennis-yellow/10 to-tennis-yellow/5 rounded-2xl p-8 mb-8 border-l-4 border-tennis-yellow">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Das Kinder- und Jugendtraining und das Mannschaftsspielen bereits in jungen Jahren 
                    hat bei uns eine lange Tradition. Unser Verein ist stolz darauf, junge Talente zu 
                    fördern und ihnen eine solide tennissportliche Grundlage zu vermitteln.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-4 gap-6 mb-8">
                  <div className="bg-tennis-black rounded-xl p-6 text-center text-white">
                    <div className="text-3xl font-bold text-tennis-yellow mb-2">16</div>
                    <div className="text-sm font-medium">Jugendmannschaften</div>
                  </div>
                  <div className="bg-tennis-yellow rounded-xl p-6 text-center">
                    <div className="text-3xl font-bold text-tennis-black mb-2">4</div>
                    <div className="text-sm font-medium text-tennis-black">Altersklassen</div>
                  </div>
                  <div className="bg-gray-100 rounded-xl p-6 text-center">
                    <div className="text-3xl font-bold text-gray-800 mb-2">2024</div>
                    <div className="text-sm font-medium text-gray-600">Aktuelle Saison</div>
                  </div>
                  <div className="bg-gradient-to-br from-tennis-yellow/20 to-tennis-yellow/10 rounded-xl p-6 text-center">
                    <div className="text-3xl font-bold text-tennis-black mb-2">U10-U18</div>
                    <div className="text-sm font-medium text-gray-700">Altersbereich</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border-2 border-gray-200 mb-12">
            ...
            <div className="p-8">
              <p className="text-gray-700 text-center mb-8">
                Hier finden Sie die aktuelle Übersicht über alle 16 Jugendmannschaften unseres 
                TC Schwarz-Gelb Heidelberg e.V. in 2024
              </p>
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      <p className="text-sm text-gray-600">
                        {mannschaften.length} Mannschaft{mannschaften.length > 1 ? 'en' : ''}
                      </p>
                    </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-tennis-black rounded-2xl p-8 text-white">
              ...
              <p className="leading-relaxed mb-4">
                Unser Verein bietet für alle Altersgruppen und Leistungsstärken die passende 
                Mannschaft. Von den ersten Schritten auf dem Midcourt bis hin zu ambitionierten 
                Jugendlichen ist für jeden etwas dabei.
              </p>
            ...
            <div className="bg-gradient-to-br from-tennis-yellow/10 to-tennis-yellow/5 rounded-2xl p-8 border-2 border-tennis-yellow/20">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Wir fördern nicht nur die tennissportlichen Fähigkeiten, sondern legen auch 
                großen Wert auf Teamgeist, Fair Play und die persönliche Entwicklung unserer 
                Nachwuchstalente.
              </p>
