...
export const upcomingEvents: ClubEvent[] = [
  ...
  },
  {
    ...
    time: { de: "ganztägig", en: "All day" },
    title: { de: "1. Osterferien-Camp (Kinder) / Workshop (Erwachsene)", en: "1st Easter Camp (Children) / Workshop (Adults)" },
    location: { de: "Tennisanlage", en: "Tennis Facility" },
    description: { de: "Tenniscamp für Kinder und Workshop für Erwachsene in den Osterferien", en: "Tennis camp for children and workshop for adults during Easter holidays" },
    type: "camp",
  },
  {
    id: "lk-turnier-jugend-ostern",
    date: "11.04.2026",
    time: { de: "ganztägig", en: "All day" },
    title: { de: "Ostern LK-Jugend Turnier – für M12w, M12m, M14w, M14m", en: "Easter LK Youth Tournament – for G12, B12, G14, B14" },
    location: { de: "Schwarz-Gelb Tennisanlage", en: "Schwarz-Gelb Tennis Facility" },
    description: { de: "Organisiert vom Förderverein. Anmeldung über www.tennis.de. Anmeldeschluss: 07.04.2026 20 Uhr, Auslosung: 07.04.2026 21 Uhr", en: "Organized by the Förderverein. Registration via www.tennis.de. Registration deadline: 07.04.2026 8 PM, Draw: 07.04.2026 9 PM" },
    type: "tournament",
  },
  {
    id: "lk-turnier-tagesturnier-ostern",
    date: "12.04.2026",
    time: { de: "ganztägig", en: "All day" },
    title: { de: "Ostern LK Tagesturnier – für W40, W50, M40, M50", en: "Easter LK Day Tournament – for W40, W50, M40, M50" },
    location: { de: "Schwarz-Gelb Tennisanlage", en: "Schwarz-Gelb Tennis Facility" },
    description: { de: "Organisiert vom Förderverein. Anmeldung über Tennis.de. Anmeldeschluss: 08.04.2026 20 Uhr, Auslosung: 08.04.2026 21 Uhr", en: "Organized by the Förderverein. Registration via Tennis.de. Registration deadline: 08.04.2026 8 PM, Draw: 08.04.2026 9 PM" },
    type: "tournament",
  },
  {
